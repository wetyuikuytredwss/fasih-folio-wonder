...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Portfolio of Muhammad Fasih Ur Rehman — student leader, conference delegate, and builder of creative projects at H.H. Sheikh Khalifa Public School." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Muhammad Fasih Ur Rehman — Student. Leader. Builder." },
      { name: "twitter:description", content: "Portfolio of Muhammad Fasih Ur Rehman — student leader, conference delegate, and builder of creative projects at H.H. Sheikh Khalifa Public School." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/d16e2fa0-ab8e-4a63-af2b-64a18b7c6863/id-preview-732d00bf--e4c575d5-bf1e-4eca-b3bb-6579e23cb64c.lovable.app-1781357798176.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/d16e2fa0-ab8e-4a63-af2b-64a18b7c6863/id-preview-732d00bf--e4c575d5-bf1e-4eca-b3bb-6579e23cb64c.lovable.app-1781357798176.png" },
    ],
    links: [
